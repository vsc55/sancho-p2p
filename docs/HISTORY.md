...
| `0.9.12` | **UI fixes** — section buttons no longer paint a black/white box behind the 32-bit icons (Transfers/Search/Console) when active or hovered; the tray icon no longer opens a half-built empty window when double-clicked during the startup splash | [Release](https://github.com/vsc55/sancho-p2p/releases/tag/0.9.12) |
